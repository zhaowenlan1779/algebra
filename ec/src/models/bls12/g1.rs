...
pub type G1ExtendedJacobian<P> = ExtendedJacobian<<P as Bls12Config>::G1Config>;
...
impl<P: Bls12Config> From<G1ExtendedJacobian<P>> for G1Prepared<P> {
...
impl<'a, P: Bls12Config> From<&'a G1ExtendedJacobian<P>> for G1Prepared<P> {
